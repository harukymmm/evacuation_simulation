...
MENTAL_STATE_TEMPLATES = {
    ...
    "正常性バイアス・楽観的": {
        "priority": "様子見・現状維持",
        "context_templates": [
            "あなたは「大丈夫だろう」と考える傾向があります。過去の経験から、今回も大事には至らないと楽観視しています。",
            "あなたは「きっと誤報だろう」と考えています。SNSで情報を確認してから動こうとします。",
            "あなたは「まだ慌てる必要はない」と考えています。まずは状況を見極めてから行動しようとします。",
            "あなたは「この程度なら大丈夫」と考える傾向があります。すぐには避難行動を起こしません。",
            "あなたは警報が出ても「大げさだろう」と考えます。落ち着いて様子を見ようとします。",
        ]
    },
    "同調性・集団追従": {
        "priority": "周囲に合わせる",
